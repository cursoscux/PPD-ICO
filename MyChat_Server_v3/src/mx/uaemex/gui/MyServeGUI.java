 ...
 * @author renecruz
 */
public class MyServeGUI extends javax.swing.JFrame {
  ...
  public MyServeGUI() {
    initComponents();
    try {
      setTitle("MyChatServer v3.0 ["+ InetAddress.getLocalHost() +"]");
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(MyServeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new MyServeGUI().setVisible(true);
      }
    });
  }
